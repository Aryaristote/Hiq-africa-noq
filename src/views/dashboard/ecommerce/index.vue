            ...
            <b-col cols="12">
              <div class="d-flex align-items-lg-center flex-lg-row flex-column">
                <div class="flex-grow-1">
                  <h4 class="fs-16 mb-1">Good Morning, Kagarama Corner Store!</h4>
                    ...
                    <b-row class="g-3 mb-0 align-items-center">
                      <div class="col-auto">
                        <b-button type="button" variant="soft-success">
                          <i class="ri-shopping-cart-2-line align-middle me-1"></i>
                          Sales Manager</b-button>
                      </div>
                      <div class="col-auto">
                ...
                <b-card-body>
                  <div class="d-flex align-items-center">
                    <div class="flex-grow-1 overflow-hidden">
                      <p class="text-uppercase fw-bold text-primary text-truncate mb-0">
                        Total Sales</p>
                    </div>
                  ...
                  <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                      <h4 class="fs-22 fw-semibold ff-secondary mb-4">
                        Rwf <count-to :startVal='0' :endVal='59' :duration='5000'></count-to>k
                      </h4>
            ...
            <b-col xl="3" md="6">
              <b-card no-body class="card-animate">
                <b-card-body>
                  ...
                  <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                      <h4 class="fs-22 fw-semibold ff-secondary mb-4"><count-to :startVal='0.1' :endVal='1'
            ...
            <b-col xl="3" md="6">
              <b-card no-body class="card-animate">
                <b-card-body>
                  ...
                  <div class="d-flex align-items-end justify-content-between mt-4">
                    <div>
                      <h4 class="fs-22 fw-semibold ff-secondary mb-4">Rwf <count-to :startVal='0' :endVal='165'
                          :duration='5000'></count-to>k
                      </h4>

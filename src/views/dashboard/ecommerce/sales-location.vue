<script>
  ...
  import usaJson from "../../../components/widgets/world.json";
  ...
  <b-card no-body class="card-height-100">
    ...
    <b-card-body>
      <div class="px-2 py-2 mt-1">
        <p class="mb-1">Rwanda <span class="float-end">75%</span></p>
        <b-progress striped :value="75" class="mt-2" variant="primary" style="height: 6px;" />

        <p class="mt-3 mb-1">Kenya <span class="float-end">47%</span></p>
        <b-progress striped :value="47" class="mt-2" variant="primary" style="height: 6px;" />

        <p class="mt-3 mb-1">Uganda <span class="float-end">82%</span></p>

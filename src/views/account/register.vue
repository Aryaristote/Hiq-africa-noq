                ...
                <div class="p-2 mt-2">
                  <div class="mt-1 text-center">
                      ...
                      <div>
                        ...
                        <b-button type="button" variant="primary" class="btn-icon ms-1"><i
                            class="ri-linkedin-fill fs-16"></i></b-button>
                      </div>
                    </div>
                  <form class="needs-validation" @submit.prevent="tryToRegisterIn">
                    ...
                    <div class="mb-4">
                      <p class="mb-0 fs-12 text-muted fst-italic">By registering you agree to the <b-link

  ...
  <header id="page-topbar">
    <div class="layout-width">
      <div class="navbar-header">
        <div class="d-flex">
          ...
          <form class="app-search d-none d-md-block">
            <div class="position-relative">
              ...
              <div class="btn-group">
                <button type="button" class="btn btn-primary">Market Supermarket</button>
        ...
        <!-- Buttons with Label -->
        <button type="button" class="btn btn-success btn-label waves-effect right waves-light"><i
            class="ri-add-line label-icon align-middle fs-16 ms-2"></i> New Sale</button>
          ...
          <div class="dropdown ms-sm-3 header-item">
            <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
              ...
              <span class="d-flex align-items-center">
                <img class="rounded-circle header-profile-user" src="https://ui-avatars.com/api/?name=Kohn+Coe"
                  alt="Header Avatar" />
              </span>
            </button>
